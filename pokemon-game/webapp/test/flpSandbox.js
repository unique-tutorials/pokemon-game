		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#compokemonuxpokemongame-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"compokemonuxpokemongame-display": {
								"semanticObject": "compokemonuxpokemongame",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.pokemon.ux.pokemongame",
									"url": sap.ui.require.toUrl("com/pokemon/ux/pokemongame")
								}
							}
						}
					}
